...
header.innerHTML = "Connect Four";
connectFourContainer.append(header);

var player = document.createElement("h3");
player.innerHTML = "The current player is: Player: <span id='current-player'>1</span>";
connectFourContainer.append(player);

var resultH = document.createElement("h3");
resultH.setAttribute("id", "result");
connectFourContainer.append(resultH);
...
grid.setAttribute("class", "grid");
    ...
    connectFourContainer.append(grid);
    gamingArea.append(connectFourContainer);
